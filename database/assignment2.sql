...
--task 1: insert a new record into the account
...
--task 4: modify the GM Hummer recoed description
...
--task 6: update inv_image and inv_thumbnail path to include "/vehicles"
UPDATE public.inventory
